export default {
  ...
  floating_window_page: '漂浮窗与轮播图',
  base_info: '基本信息',
  role: '角色管理',
  user_management: '用户管理',
  log_management: '日志管理',
  floating_window_add_page: '漂浮窗与轮播图',
  floating_window_drafts_page: '漂浮窗与轮播图',
  page_configuration_page: '页面配置',
  business_statistics_page: '业务统计',
  data_management: '数据管理',
  data_backup_page: '数据备份',
  account_page: '账户管理',
  authority:"菜单管理",
}
